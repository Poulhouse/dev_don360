	...
	<div class="templateux-section">
		...
		<div class="container-fluid"  data-aos="fade-up">
			<div class="owl-carousel wide-slider">
				<div class="item">
					<img src="<?=SITE_TEMPLATE_PATH;?>/images/slider-2.jpg" alt="Free template by TemplateUX.com" class="img-fluid">
				</div>
				<div class="item">
					<img src="<?=SITE_TEMPLATE_PATH;?>/images/slider-3.jpg" alt="Free template by TemplateUX.com" class="img-fluid">
				</div>
				<div class="item">
					<img src="<?=SITE_TEMPLATE_PATH;?>/images/slider-4.jpg" alt="Free template by TemplateUX.com" class="img-fluid">
				</div>
			</div> <!-- .owl-carousel -->
		</div>
			...
			<div class="row">
				<div class="col-md-6 col-lg-4" data-aos="fade-up">
					<div class="block-person-1">
						<img src="<?=SITE_TEMPLATE_PATH;?>/images/person_1.jpg" alt="Free template by TemplateUX" class="img-fluid">
				...
				<div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
					<div class="block-person-1">
						<img src="<?=SITE_TEMPLATE_PATH;?>/images/person_2.jpg" alt="Free template by TemplateUX" class="img-fluid">
						<div class="block-content">
				...
				<div class="col-md-12 col-lg-4" data-aos="fade-up" data-aos-delay="200">
					<div class="block-person-1">
						<img src="<?=SITE_TEMPLATE_PATH;?>/images/person_3.jpg" alt="Free template by TemplateUX"
						     class="img-fluid">
						<div class="block-content">

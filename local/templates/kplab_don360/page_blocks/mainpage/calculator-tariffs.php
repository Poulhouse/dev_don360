        ...
        <div class="index-block--CALCULATOR-TARIFFS index-block">
            ...
            <div class="calc-block--inner col-md-12 themed-grid-col">
                <div class="index-block--title-wrapper d-flex justify-content-between align-items-center">
                    <h3 class="line font_64">Калькулятор</h3>
            ...
            <div class="calc-block--inner col-md-9 themed-grid-col">
                <div class="kp-shadow p-5 mb-3 bg-body kp-rounded">
                    <div class="fs-4 pb-3">
                        <span class="color-green-element">по количеству панорам</span>
                    </div>

                    <div class="row text-center align-items-center">
                        <div class="col-md-2">
                            <div class="d-flex flex-column active">
                                <span class="fs-3 text fw-bolder"><span id="sumValue_1">900</span><span>₽</span></span>
                                <span class="text-muted">Тариф «Стандарт»</span>
                            </div>
                        </div>
                        <div class="col-md-1"><span class="font_b color-green-element">или</span></div>
                        <div class="col-md-2">
                            <div class="d-flex flex-column active">
                                <span class="fs-3 text fw-bolder"><span id="sumValue_1">900</span><span>₽</span></span>
                                <span class="text-muted">Тариф «Стандарт»</span>
            ...
            <div class="calc-block--inner col-md-3 themed-grid-col">

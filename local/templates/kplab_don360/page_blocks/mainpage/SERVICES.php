<div class="container index-block--delimiter bg-light">
    <div class="maxwidth-theme">
        <div class="index-block--SERVICES index-block py-80">

            <div class="services-block--inner col-md-12 themed-grid-col">
                <div class="index-block--title-wrapper d-flex justify-content-between align-items-center">
                    <h3 class="line font_64">Услуги</h3>
                    <a class="index-block--link link-dark fill-theme-hover right-link" href="/services/" title="Перейти в раздел">
							<span class="index-block--arrow">
								<i class="svg inline fill fill-999" aria-hidden="true">
                ...
                <div class="index-block--preview mb-5">
                                    ...
                                    <div class="kp-shadow p-5 mb-3 bg-body kp-rounded">
                                        ...
                                        <div class="pb-30">
                                            <div class="row align-items-start">
                                                <div class="col">
                                                    <span class="fs-2 text fw-bolder">900₽</span>
                                                </div>
                                                <div class="col">
                                                    <span class=" text fs-6 fw-bold text-muted" style="margin-top: -8px;">/панорама</span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-3 ">
                                    <div class="kp-shadow p-5 mb-3 bg-body kp-rounded">
                                        ...
                                        <div class="pb-30">
                                            <div class="row align-items-start">
                                                <div class="col">
                                                    <span class="fs-2 text fw-bolder">1400₽</span>
                                                </div>
                                                <div class="col">
                                                    <span class=" text fs-6 fw-bold text-muted" style="margin-top: -8px;">/панорама</span>
                                                </div>
                                ...
                                <div class="col-md-3 ">
                                    <div class="kp-shadow p-5 mb-3 bg-body kp-rounded">
                                        ...
                                        <div class="pb-30">
                                            <div class="row align-items-start">
                                                <div class="col">
                                                    <span class="fs-2 text fw-bolder">1900₽</span>
                                                </div>
                                                <div class="col">
                                                    <span class=" text fs-6 fw-bold text-muted" style="margin-top: -8px;">/панорама</span>
                                                </div>
                                ...
                                <div class="col-md-3 ">
                                    <div class="kp-shadow p-5 mb-3 bg-body kp-rounded">
                                        ...
                                        <div class="pb-30">
                                            <div class="row align-items-start">
                                                <div class="col">
                                                    <span class="fs-2 text fw-bolder">2400₽</span>
                                                </div>
                                                <div class="col">
                                                    <span class=" text fs-6 fw-bold text-muted" style="margin-top: -8px;">/панорама</span>
                                                </div>
                                    ...
                                    <div class="kp-shadow p-5 mb-3 bg-body kp-rounded">
                                        ...
                                        <div class="pb-30">
                                            <div class="row align-items-start">
                                                ...
                                                <div class="col">
                                                    <span class=" text fs-6 fw-bold text-muted" style="margin-top: -8px;"></span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4 ">
                                    <div class="kp-shadow p-5 mb-3 bg-body kp-rounded">
                                        ...
                                        <div class="pb-30">
                                            <div class="row align-items-start">
                                                <div class="col">
                                                    <span class="fs-2 text fw-bold">3000₽</span>
                                                </div>
                                                <div class="col">
                                                    <span class=" text fs-6 fw-bold text-muted" style="margin-top: -8px;">Скидка -25%</span>
                                                </div>
                                            </div>
                                        </div>

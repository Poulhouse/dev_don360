<?require($_SERVER["DOCUMENT_ROOT"]."/bitrix/header.php"); $APPLICATION->SetTitle("Главная");?>
	...
	<div class="templateux-cover" style="background-image: url(<?=SITE_TEMPLATE_PATH;?>/images/slider-1.jpg);">
		<div class="container">
	...
	<div class="templateux-section">
		...
		<div class="container-fluid"  data-aos="fade-up">
			<div class="owl-carousel wide-slider">
				<div class="item">
					<img src="<?=SITE_TEMPLATE_PATH;?>/images/slider-2.jpg" alt="Free template by TemplateUX.com"
					     class="img-fluid">
				</div>
				<div class="item">
					<img src="<?=SITE_TEMPLATE_PATH;?>/images/slider-3.jpg" alt="Free template by TemplateUX.com"
					     class="img-fluid">
				</div>
				<div class="item">
					<img src="<?=SITE_TEMPLATE_PATH;?>/images/slider-4.jpg" alt="Free template by TemplateUX.com"
					     class="img-fluid">
				</div>
			</div> <!-- .owl-carousel -->
		</div>
	...
	<div class="templateux-section">
		<div class="d-flex flex-column flex-sm-row">
			<a href="#" class="block-thumbnail-1 one-third" style="background-image: url('<?=SITE_TEMPLATE_PATH;
			?>/images/slider-2.jpg'); " data-aos="fade">
				<div class="block-thumbnail-content">
					<h2>When she reached the first</h2>
					<span class="post-meta">Design, Illustration</span>
				</div>
			</a>
			<a href="#" class="block-thumbnail-1 two-third" style="background-image: url('<?=SITE_TEMPLATE_PATH;
			?>/images/slider-1.jpg'); " data-aos="fade" data-aos-delay="100">
				<div class="block-thumbnail-content">
		...
		<div class="d-flex flex-column flex-sm-row">
			<a href="#" class="block-thumbnail-1 two-third" style="background-image: url('<?=SITE_TEMPLATE_PATH;
			?>/images/slider-3.jpg'); " data-aos="fade" data-aos-delay="200">
				<div class="block-thumbnail-content">
			...
			<a href="#" class="block-thumbnail-1 one-third" style="background-image: url('<?=SITE_TEMPLATE_PATH;
			?>/images/slider-4.jpg'); " data-aos="fade" data-aos-delay="300">
				<div class="block-thumbnail-content">

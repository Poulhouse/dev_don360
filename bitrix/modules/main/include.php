...
/*ZDUyZmZNjJiNTczNWIzNjMyMDcxN2JhZGVhZjBmZWRiMTAyYzg=*/$GLOBALS['____301196448']= array(base64_decode('ZGVmaW5l'));if(!function_exists(__NAMESPACE__.'\\___2102626035')){function ___2102626035($_1362061861){static $_2015692414= false; if($_2015692414 == false) $_2015692414=array('RU'.'5DT0RF','W'.'Q==');return base64_decode($_2015692414[$_1362061861]);}};class CBXFeatures{ public static function IsFeatureEnabled($_1813030993){ return true;} public static function IsFeatureEditable($_1813030993){ return true;} public static function SetFeatureEnabled($_1813030993, $_269730783= true){} public static function SaveFeaturesSettings($_868385145, $_1608495909){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_310462857){} public static function ModifyFeaturesSettings($_310462857, $_416482432){} public static function IsFeatureInstalled($_1813030993){ return true;}} $GLOBALS['____301196448'][0](___2102626035(0), ___2102626035(1));/**/			//Do not remove this
